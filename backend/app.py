...
if __name__ == '__main__':
    print("=" * 50)
    print("Complaint Management System - Backend API")
    print("=" * 50)
    ...
    print("  GET    /api/complaints/me")
    print("  GET    /api/complaints/all")
    print("  GET    /api/complaints/track/<token>")
    print("  POST   /api/admin/login")
    print("  GET    /api/admin/complaints")
    print("  PUT    /api/admin/complaints/<id>")
    print("  DELETE /api/admin/complaints/<id>")
